...
local function set_highlights()
    local utilities = require("greenery.utilities")
    local palette = require("greenery.palette")
    ...
    local default_highlights = {
        ...
        ["@variable"] = { fg = palette.foam, italic = styles.italic },
        -- ["@variable"] = { fg = palette.text, italic = styles.italic },
        -- ["@variable.builtin"] = { fg = palette.love, italic = styles.italic, bold = styles.bold },
        ["@variable.builtin"] = { fg = palette.rose, italic = styles.italic, bold = styles.bold },
        ...
        ["@property"] = { fg = palette.foam, italic = styles.italic, bold = styles.bold },

        ["@function"] = { fg = palette.rose },
        ["@keyword.function"] = { fg = "#ADC586" },
    ...
    if config.options.enable.terminal then
		...
		augroup greenery
			...
			autocmd ColorSchemePre * autocmd! greenery
		augroup END
		]])
    end
end
